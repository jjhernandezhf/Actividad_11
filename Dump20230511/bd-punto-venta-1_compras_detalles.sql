...
CREATE TABLE `compras_detalles` (
  ...
  CONSTRAINT `compras_detalles_ibfk_1` FOREIGN KEY (`compra_id`) REFERENCES `compras` (`id`),
  CONSTRAINT `compras_detalles_ibfk_2` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`)
